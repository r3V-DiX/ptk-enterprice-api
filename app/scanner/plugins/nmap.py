...
_HIGH_RISK_PORTS = {
    ...
    23: ("high", "Telnet Service Exposed on Port 23",
         "Telnet transmits all data including credentials in plaintext. Use SSH instead."),
    ...
    5432: ("high", "PostgreSQL Database Port Exposed",
           "PostgreSQL port should not be publicly accessible."),
    6379: ("high", "Redis Port Exposed — Potential Unauthenticated Access",
           "Redis is often deployed without authentication. Bind to localhost only."),
    27017: ("high", "MongoDB Port Exposed",
            "MongoDB port should not be publicly accessible."),
    9200: ("high", "Elasticsearch Port Exposed",
           "Elasticsearch port should not be publicly accessible. Often unauthenticated."),
    5984: ("high", "CouchDB Port Exposed",
           "CouchDB port should not be publicly accessible."),
    11211: ("high", "Memcached Port Exposed",
            "Memcached is often deployed without authentication."),
}
